...
public class {{ RootName }}Application {
    ...
    public {{ RootName }}Application(String applicationName, Class<?>... primarySources) {
        this.applicationName = applicationName;
        this.springApplication = new SpringApplication(primarySources);
    }

    public {{ RootName }}Application() {
        this("{{ artifact_id }}");
    }

    public {{ RootName }}Application(String applicationName) {
        this(applicationName, {{ RootName }}ApplicationConfig.class);
    }
    ...
    public {{ RootName }}Application disableJmx() {
        this.disableJmx = true;
        return this;
    }

    public {{ RootName }}Application withArguments(String... args) {
    ...
    public static void main(String[] args) {
        new {{ RootName }}Application().withArguments(args).start();
    }
}
